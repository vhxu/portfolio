      ...
      <div className='editor-section'>
        <div className='editor-container'>
          ...
          <div className='editor-window'>
            ...
            <div className='grey'><span className='numbers'>4</span><span className='indent2'>resume</span><span className='turquoise'>:</span><span className='green space-left'><a href='#'>'Virgil Xu resume.pdf'</a></span>,</div>
            <div className='grey'><span className='numbers'>5</span><span className='indent2'>email</span><span className='turquoise'>:</span><span className='green space-left'><a href='mailto:virgilxu89@gmail.com'>'virgilxu89@gmail.com'</a></span>,</div>
            <div className='grey'><span className='numbers'>6</span><span className='indent2'>Github</span><span className='turquoise'>:</span><span className='green space-left'><a href='https://github.com/vhxu'>'Github'</a></span>,</div>
            <div className='grey'><span className='numbers'>7</span><span className='indent2'>LinkedIn</span><span className='turquoise'>:</span><span className='green space-left'><a href='https://www.linkedin.com/in/virgil-xu-261b3550'>'LinkedIn'</a></span>,</div>
